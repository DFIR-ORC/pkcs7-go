...
var (
	...
	OIDEncryptionAlgorithmRSAOAEPSHA1   = asn1.ObjectIdentifier{1, 2, 840, 113549, 1, 1, 7}
	OIDEncryptionAlgorithmRSAOAEPSHA256 = asn1.ObjectIdentifier{1, 2, 840, 113549, 1, 1, 10}
